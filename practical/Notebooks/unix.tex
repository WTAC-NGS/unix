...
\tightlist
\item
  Describe why UNIX is suitable for analysing NGS data
\item
...
directory.
    ...
    \texttt{/home/manager/course\_data/unix/practical/Notebooks/basic/Styphi}
...
\item
  ...
  works on commands. Try it by typing \texttt{tai} and pressing the
  \texttt{tab} key.
\end{itemize}
...
\item
  Use the \texttt{uniq} command to count the number of features in
  chromosome 7 in the \texttt{Pfalciparum.bed} file. Hint: use the man
