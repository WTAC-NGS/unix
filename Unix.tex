...
\PY{n+nb}{cd} /home/manager/pathogen\PYZhy{}informatics\PYZhy{}training/Notebooks/Unix/
\end{Verbatim}
\end{tcolorbox}
...
To get started with the tutorial, head to the next section:
...
\end{tcolorbox}
    ...
    \texttt{/home/manager/pathogen-informatics-training/Notebooks/Unix/}
...
But first, change directory into the \texttt{Unix/files/} directory. You
may find Figure 1 useful here as depending on the directory you are
...
Before you start this section change into the
\texttt{Unix/advanced\_bash} directory:
